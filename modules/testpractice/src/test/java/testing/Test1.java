...
//Task 1
        ...
        Assert.assertEquals("eCommerce Store", title);
//Task 2
...
// Task 3
        WebElement ele1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h3[contains(text(),'Home Essentials')]")));
...
// Task 4
        ...
        String Url = driver.getCurrentUrl();
        details1.add(url);
        WebElement totalPrice = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#root > div > div > div > div > h3")));
